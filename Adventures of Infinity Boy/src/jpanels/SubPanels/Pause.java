...
public class Pause extends JPanel{
	...
	private static ImageIcon[] imgTitle = Engine.getScaledImageicon("titlePause", Init.TITLE_SIZE[0] * scaleX, Init.TITLE_SIZE[1] * scaleY);
	private static ImageIcon[] imgResume = Engine.getScaledImageicon("buttonResume", Init.BUTTON_SET_SIZE[0] * scaleX, Init.BUTTON_SET_SIZE[1] * scaleY);
	...
	JLabel[] buttons = {new JLabel(), new JLabel(), new JLabel()};
	...
	public Pause() {
		...
		buttons[0].setIcon(imgResume[0]);
		buttons[1].setIcon(imgRetry[0]);
		buttons[2].setIcon(imgMainmenu[0]);
		
		Engine.animateLabel(buttons[0], imgResume, "resume");
